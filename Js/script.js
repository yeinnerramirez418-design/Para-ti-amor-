...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para el futuro amor de mi vida:\n\nAmor, sé que hemos estado varias veces a punto de dejarnos ir, pero quiero que, por medio de este mensaje, sepas lo importante que te has vuelto para mí y lo difícil que va a ser que no seas mía.\n\nMe has hecho sentir tan bien como no me habían hecho sentir antes. Cada cambio que haces en ti para ser un poco más mi complemento lo valoro muchísimo, aunque no lo parezca. Te prometo que iré por ti, y vas a ver que seremos felices...\n\nGracias por decidir quedarte a mi lado con todo lo complicado, celoso y sensible que puedo llegar a ser, porque sé que es una decisión diaria; por entenderme incluso en silencio, en discusiones, y por llenar mis días de este sentimiento tan lindo que generas en mí.\n\nTe amito muucho más de lo que las palabras pueden expresar.`; } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Att: Yei, el futuro amor de tu vida";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML = 
      `Te amito mucho más de lo que las palabras pueden expresar.<br><br>`
  }
  update();
